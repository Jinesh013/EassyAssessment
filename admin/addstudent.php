...
<body>
    ...
    if($module=="student")
        {
        $query    = "INSERT into `student` (name,username,password,yearcode,branch,currsem,module, create_datetime) VALUES ('$name','$username','$password', '$yearcode','$branch','$currsem','$module', '$create_datetime')";
